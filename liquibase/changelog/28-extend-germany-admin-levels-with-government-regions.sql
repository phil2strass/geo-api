...
--changeset codex:28-extend-germany-admin-levels-with-government-regions dbms:postgresql
--comment Extend the curated Germany hierarchy with the official Regierungsbezirk level.
